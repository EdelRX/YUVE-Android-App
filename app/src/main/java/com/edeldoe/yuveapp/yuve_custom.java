...
public class yuve_custom extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            new DownloadCustomList().execute(); // Call the asynctask to download watchlist movie info
        } else {
        ...
        mTextView.setText(yuve_start.custom_title);
        setContentView(R.layout.activity_yuve_custom);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                intent = new Intent(yuve_custom.this, yuve_movie.class);
                yuve_start.index = position;
                startActivity(intent);
                yuve_start.preceding = "customlist";
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View v,
                ...
                String title = (String) DownloadCustomList.titlelist6.get(position);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() { // Le ponemos un listener a la lista
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 0:
                        intent = new Intent(yuve_custom.this, miyuve.class);
                        startActivity(intent);
                        break;
                    case 1:
                        intent = new Intent(yuve_custom.this, yuve_popular.class);
                        startActivity(intent);
                        break;
                    case 2:
                        intent = new Intent(yuve_custom.this, yuve_nowplaying.class);
                        startActivity(intent);
                        break;
                    case 3:
                        intent = new Intent(yuve_custom.this, yuve_opening.class);
                        startActivity(intent);
                        break;
                    case 4:
                        intent = new Intent(yuve_custom.this, yuve_favorites.class);
                        startActivity(intent);
                        break;
                    case 5:
                        intent = new Intent(yuve_custom.this, yuve_watchlist.class);
                        startActivity(intent);
                        break;
                    case 6:
                        intent = new Intent(yuve_custom.this, yuve_custom.class);
                        startActivity(intent);
                        break;
                    case 7:
                        intent = new Intent(yuve_custom.this, yuve_maps.class);
                        startActivity(intent);
                        break;
                }
    ...
    protected void onResume() {
        super.onResume();
        activity = this; // Set reference to this activity to reference from other classes
        if(yuve_start.custommodify) {

            yuve_custom.activity.findViewById(R.id.progress_bar).setVisibility(View.VISIBLE);
            gridView.setVisibility(View.INVISIBLE);
            ConnectivityManager connMgr = (ConnectivityManager)
                    getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo networkInfo = connMgr.getActiveNetworkInfo();
            if (networkInfo != null && networkInfo.isConnected()) {
                DownloadCustomList.imageItems6 = new ArrayList<>();
                new DownloadCustomList().execute(); // Call the asynctask to download watchlist movie info
            } else {
                Toast.makeText(activity, "No internet connection.", Toast.LENGTH_LONG).show();
            }
            yuve_start.custommodify = false;
        }

        clear_fav_button = (Button) findViewById(R.id.favorite_button);
        if(DownloadCustomList.imageItems6.isEmpty()){
    ...
    public void performSearch(String q){
        ...
        Intent intent = new Intent(yuve_custom.this, yuve_search_results.class);
    ...
    public void clearCustomlist(View v){

        yuve_start.custommodify = true;
        yuve_start.custommodify2 = true;

        //Retrieve watchlist
        yuve_start.customlist = new ArrayList<String>();
        yuve_start.custom_string = yuve_start.myPref.getString("customlist", yuve_start.custom_string);
