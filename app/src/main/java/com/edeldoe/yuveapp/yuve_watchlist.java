...
public class yuve_watchlist extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            new DownloadWatchlist().execute(); // Call the asynctask to download watchlist movie info
        } else {
        ...
        mTextView.setText(yuve_start.ctx.getString(R.string.Watchlist));
        setContentView(R.layout.activity_yuve_watchlist);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                intent = new Intent(yuve_watchlist.this, yuve_movie.class);
                yuve_start.index = position;
                startActivity(intent);
                yuve_start.preceding = "watchlist";
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View v,
                ...
                String title = (String) DownloadWatchlist.titlelist4.get(position);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() { // Le ponemos un listener a la lista
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 0:
                        intent = new Intent(yuve_watchlist.this, miyuve.class);
                        startActivity(intent);
                        break;
                    case 1:
                        intent = new Intent(yuve_watchlist.this, yuve_popular.class);
                        startActivity(intent);
                        break;
                    case 2:
                        intent = new Intent(yuve_watchlist.this, yuve_nowplaying.class);
                        startActivity(intent);
                        break;
                    case 3:
                        intent = new Intent(yuve_watchlist.this, yuve_opening.class);
                        startActivity(intent);
                        break;
                    case 4:
                        intent = new Intent(yuve_watchlist.this, yuve_favorites.class);
                        startActivity(intent);
                        break;
                    case 5:
                        intent = new Intent(yuve_watchlist.this, yuve_watchlist.class);
                        startActivity(intent);
                        break;
                    case 6:
                        intent = new Intent(yuve_watchlist.this, yuve_custom.class);
                        startActivity(intent);
                        break;
                    case 7:
                        intent = new Intent(yuve_watchlist.this, yuve_maps.class);
                        startActivity(intent);
                        break;
                }
    ...
    protected void onResume() {
        ...
        if(yuve_start.watchmodify) {

            yuve_watchlist.activity.findViewById(R.id.progress_bar).setVisibility(View.VISIBLE);
            gridView.setVisibility(View.INVISIBLE);
            ConnectivityManager connMgr = (ConnectivityManager)
                    getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo networkInfo = connMgr.getActiveNetworkInfo();
            if (networkInfo != null && networkInfo.isConnected()) {
                DownloadWatchlist.imageItems4 = new ArrayList<>();
                new DownloadWatchlist().execute(); // Call the asynctask to download watchlist movie info
            } else {
                Toast.makeText(activity, "No internet connection.", Toast.LENGTH_LONG).show();
            }
            yuve_start.watchmodify = false;
        }
        clear_fav_button = (Button) findViewById(R.id.favorite_button);
        if(DownloadWatchlist.imageItems4.isEmpty()){
    ...
    public void performSearch(String q){
        ...
        Intent intent = new Intent(yuve_watchlist.this, yuve_search_results.class);
    ...
    public void clearWatchlist(View v){

        yuve_start.watchmodify = true;
        yuve_start.watchmodify2 = true;

        //Retrieve watchlist
        yuve_start.watchlist = new ArrayList<String>();
        yuve_start.watchlist_string = yuve_start.myPref.getString("watchlist", yuve_start.watchlist_string);
